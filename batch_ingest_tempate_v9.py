...
- works with 'smart_chunk.py' program.
- requires a .env file
- may require a .tools_env file
...
#------------ bulk_file_ingestion -----------------#
URL_FOR_BULK_FILE_INGESTION = f"http://localhost:{this_port}/dt/{endpoint_name}"
...
for this_file_path in list_of_file_paths:
    ...
    with open(this_file_path, "rb") as file:
        ...
        headers = {None}  # TODO Code_Here

        # note: format url with .../dt/... before the endpoint name
        ...
        with open(this_file_path, "rb") as file:
            ...
            try:
                ...
                if status_code == 200:
                    ...
                    failed_files_to_rety_list.pop(this_file_path)
